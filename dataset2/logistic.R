...
data2logistic<-glm(formula = isFraud~.,family = binomial(link="logit"),data = train)
data2logisticpred<-predict(data2logistic,test,type = "response")
data2logisticpred<-ifelse(data2logisticpred>0.5,1,0)
