...
library(ranger)
data3random<-ranger(fraud~.,data = train,num.trees = 1000,importance = "impurity")
data3randompred<-predict(data3random,test)

A(data3randompred$predictions,test$fraud)
